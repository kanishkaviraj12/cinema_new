                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            gradient: LinearGradient(
                                colors: [
                              Color.fromARGB(255, 0, 140, 5).withOpacity(0.3),
                              transparent
                            ],
                                stops: const [
                              0.35,
                  ...
                  Positioned(
                    ...
                    child: ClipPath(
                      ...
                      child: Container(
                        height: 50,
                        width: MediaQuery.of(context).size.width,
                        color: Color.fromARGB(255, 23, 81, 24),
                      ),
                    ),
                  )
                ],
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: MaterialButton(
                                    ...
                                    color: Color.fromARGB(255, 0, 154, 5),
                                    height: 66,
                                    child: Center(
                                      child: Text(
                                        'Book Ticket',
